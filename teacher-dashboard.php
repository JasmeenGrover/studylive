        ...
        $(document).ready(function() {
          //Blog
            $("#btnSave").click(function() {
                ...
                var dor = $("#dor").val();
                var txtBlog = $("#txtBlog").val();
                // console.log(txtBlog);
                // var dPressure = $("#dPressure").val();
                // var pulse = $("#pulse").val();
                var url = "ajax-blog.php?uid=" + txtUid + "&dateofrecord=" + dor + "&blog=" + txtBlog;
...
<body>
    ...
    <div class="form-row d-flex justify-content-center text-center">
        <div class="col-md-12 header" style="height:70px;">
            <div class="d-inline-block header-text mt-3" style="margin-left:400px;margin-bottom:17px">Teacher Dashboard</div>
    ...
    <div class="pb-3">
        <div class="d-flex flex-row justify-content-center" style="margin-top:80px">
            <div class="card align-items-center shadow-sm" style="width: 15rem;">
                ...
                <div class="card-body text-center">
                    <a href="teacher-profile.php" class="btn btn-secondary text-decoration-none">Teacher profile</a>
            ...
            <div class="card align-items-center ml-5 shadow-sm" style="width: 15rem;">
                ...
                <div class="card-body text-center">
                    <a href="" class="btn btn-secondary text-decoration-none" data-toggle="modal" data-target="#modalBp">Blog Post</a>
        ...
        <div class="d-flex flex-row justify-content-center" style="margin-top:80px">
            ...
            <div class="card align-items-center ml-5 shadow-sm" style="width: 15rem;">
                ...
                <div class="card-body text-center">
                    <a href="blog-record.php" class="btn btn-secondary text-decoration-none">BP History</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Blog</h4>
                ...
                <div class="modal-body mt-2">
                    <form class="d-flex flex-column justify-content-center text-center">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="dor">Date of Post</label>
                                <input type="date" id="dor" name="dor" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="txtBlog">Your Blog</label>
                            <!-- <input type="text" id="sPressure" name="sPressure" class="form-control"> -->
                            <textarea name="txtBlog" rows="8" cols="80" class="form-control" id="txtBlog"></textarea>
                        </div>
                        <!-- <div class="form-group">
