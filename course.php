...
<body>
	...
	<section class="hero-wrap hero-wrap-2" style="background-image: url('images/image_4.jpg');">
				...
				<div class="col-lg-3 sidebar">
					...
					<div class="sidebar-box bg-white p-4 ftco-animate">
						...
						<form action="#" class="browse-form">
							...
							<label for="option-category-4"><input type="checkbox" id="option-category-4" name="vehicle" value=""> C &amp; C++ Courses</label><br>
							<label for="option-category-5"><input type="checkbox" id="option-category-5" name="vehicle" value=""> Python</label><br>
							<label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> Java &amp; Core Java</label><br>
						</form>
					</div>
