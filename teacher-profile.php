    ...
    function showpreview(file) {
        ...
        $(document).ready(function() {
            ...
            $("#btnFetch").click(function() {
                var uid = $("#txtUid").val();
                var url = "teacher-profile-json.php?uid=" + uid;
                $.getJSON(url, function(jsonArray) {
                    ...
                    $("#txtSpecial").hide().val(jsonArray[0].specialisation).fadeIn();
...
<body>
    <form action="teacher-profile-process.php" method="post" enctype="multipart/form-data">
      <input type="hidden" name="jasus" id="jasus">
        <div class=form-row>
            <div class="col-md-12 header text-center" style="height:70px;">
                <div class="d-inline-block header-text mt-3">Teacher profile</div>
            </div>
        </div>
        <div class="mt-4" style="width:1400px;margin:auto">
            ...
            <div class="form-row mt-3">
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" id="txtExp" name="txtExp">
                </div>
                <div class="form-group col-md-6">
                    <label for="txtSpecial">Specialistaion</label>
                    <input type="text" class="form-control" id="txtSpecial" name="txtSpecial">
                </div>
            </div>
            <!-- <div class="form-row mt-3">
