		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item active"><a href="instructor.php" class="nav-link">Instructor</a></li>
				...
				<div class="col-md-6 col-lg-3 ftco-animate d-flex align-items-stretch">
					<div class="staff">
						...
						<div class="text pt-3">
							...
							<div class="faded">
								<p>I am an Expert Manager.Many Americans dream of starting a business.</p>
				...
				<div class="col-md-6 col-lg-3 ftco-animate d-flex align-items-stretch">
					<div class="staff">
						...
						<div class="text pt-3">
							...
							<div class="faded">
								<p>I am a Programmer.Worked on various projects, talk about my contributions.</p>
								<ul class="ftco-social text-center">
									<li class="ftco-animate"><a href="#"><span class="fa fa-twitter"></span></a></li>
									<li class="ftco-animate"><a href="#"><span class="fa fa-facebook"></span></a></li>
									<li class="ftco-animate"><a href="#"><span class="fa fa-google"></span></a></li>
				...
				<div class="col-md-6 col-lg-3 ftco-animate d-flex align-items-stretch">
					<div class="staff">
						...
						<div class="text pt-3">
							...
							<div class="faded">
								<p>I am a Software Developer.I've worked in this field for about 17 years.</p>
								<ul class="ftco-social text-center">
									<li class="ftco-animate"><a href="#"><span class="fa fa-twitter"></span></a></li>
									<li class="ftco-animate"><a href="#"><span class="fa fa-facebook"></span></a></li>
									<li class="ftco-animate"><a href="#"><span class="fa fa-google"></span></a></li>
				...
				<div class="col-md-6 col-lg-3 ftco-animate d-flex align-items-stretch">
					<div class="staff">
						...
						<div class="text pt-3">
							...
							<span class="position mb-2">Programmer</span>
							<div class="faded">
								<p>I'm a hard-working ,sincere individual that has gained a lot of skills.</p>
								<ul class="ftco-social text-center">
									<li class="ftco-animate"><a href="#"><span class="fa fa-twitter"></span></a></li>
									<li class="ftco-animate"><a href="#"><span class="fa fa-facebook"></span></a></li>
									<li class="ftco-animate"><a href="#"><span class="fa fa-google"></span></a></li>
				...
				<div class="col-md-6 col-lg-3 ftco-animate d-flex align-items-stretch">
					<div class="staff">
						...
						<div class="text pt-3">
							...
							<span class="position mb-2">Developer</span>
							<div class="faded">
								<p> I've been working for 6 years as software developer and wrote a book also.</p>
								<ul class="ftco-social text-center">
									<li class="ftco-animate"><a href="#"><span class="fa fa-twitter"></span></a></li>
									<li class="ftco-animate"><a href="#"><span class="fa fa-facebook"></span></a></li>
									<li class="ftco-animate"><a href="#"><span class="fa fa-google"></span></a></li>
				...
				<div class="col-md-6 col-lg-3 ftco-animate d-flex align-items-stretch">
					<div class="staff">
						...
						<div class="text pt-3">
							...
							<span class="position mb-2">Graphic</span>
							<div class="faded">
								<p>I am a Graphic Designer and I am very determined to my designing work.</p>
								<ul class="ftco-social text-center">
									<li class="ftco-animate"><a href="#"><span class="fa fa-twitter"></span></a></li>
									<li class="ftco-animate"><a href="#"><span class="fa fa-facebook"></span></a></li>
									<li class="ftco-animate"><a href="#"><span class="fa fa-google"></span></a></li>
			...
			<div class="row mb-5">
				<div class="col-md pt-5">
					<div class="ftco-footer-widget pt-md-5 mb-4">
						...
						<p>As with most teaching methods, online learning also has its own set of positives and negatives. Decoding and understanding these positives and negatives will help institutes in creating strategies for more efficient delivery of the lessons, ensuring an uninterrupted learning journey for the students.</p>
